...
class Seq2Seq(nn.Module):
    ...
    """
    def __init__(self, encoder,decoder,config,bsf_len,hid_size,pad_id,bsf_context_length,beam_size=None,max_length=None,sos_id=None,eos_id=None):
    ...
    def forward(self, source_ids,source_mask,position_idx,New_DFG_ids,attn_mask,target_ids=None,target_mask=None,args=None):   
        #embedding
        ...
        DFG_embeddings=self.encoder.embeddings.word_embeddings(fin_DFG_ids).reshape(-1,self.bsf_context_length,self.hid_size)
        ...
        avg_embeddings = self.ff(avg_embeddings)
